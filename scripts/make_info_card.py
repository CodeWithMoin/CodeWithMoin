...
# ===========================================================================
HOST = "CodeWithMoin"   # shown as  CodeWithMoin@github  in the header

ROWS = [
    ("host",),
    ("kv", "Exp", "Applied Scientist Intern @ Amazon RBS"),
    ("kv", "Focus", "LLM systems, NLP, on-device ML"),
    ("kv", "Edu", "B.Tech CSE (AI/ML), MGIT '26"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "ML", "PyTorch, TensorFlow, Transformers"),
    ("kv", "GenAI", "RAG, LLM eval, Bedrock, OpenAI"),
    ("kv", "Infra", "FastAPI, Docker, Redis, pgvector"),
    ("kv", "Cloud", "AWS, GCP, SageMaker, S3"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "LLM taxonomy generation @ Amazon"),
    ("bul", "Intel edge-video sharpening pipeline"),
    ("bul", "DocuLens AI: RAG over 10K+ docs"),
    ("bul", "First author, AMLC 2026 submission"),
]
